...
class ElbowRule:
    FLEXION_COMFORT = radians(130.0)
    FLEXION_LIMIT = radians(145.0)
    HYPEREXTENSION_LIMIT = radians(5.0)
    BEND_PLANE_COMFORT = radians(90.0)
    BEND_PLANE_LIMIT = radians(120.0)
    CARRYING_ANGLE_COMFORT = radians(12.0)
    CARRYING_ANGLE_LIMIT = radians(15.0)
    ...
    def solve(
        ...
        *,
        ...
        return ElbowRuleResult(
            ...
            debug_angles={
                "elbow_flexion_degrees": degrees(applied_flexion),
                "elbow_requested_flexion_degrees": degrees(requested_flexion),
                "elbow_hyperextension_degrees": 0.0,
                ...
                "valgus_varus_degrees": min(abs(degrees(requested_plane)), degrees(self.CARRYING_ANGLE_LIMIT)),
            },
        )
    ...
    def _bend_direction(
        ...
        return fallback if length(fallback) > EPSILON else (0.0, 1.0, 0.0)
